...
class AdvisersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adviser" do
    assert_difference('Adviser.count') do
      post advisers_url, params: { adviser: { aula: @adviser.aula, horario: @adviser.horario, materia: @adviser.materia, tema: @adviser.tema } }
    end
  ...
  test "should update adviser" do
    patch adviser_url(@adviser), params: { adviser: { aula: @adviser.aula, horario: @adviser.horario, materia: @adviser.materia, tema: @adviser.tema } }
